...
if(isset($btn))
{
	...
	/* $max_qry = mysqli_query($connect, "select max(id) maxid from  department");
	$max_row = mysqli_fetch_array($max_qry);
	$id=$max_row['maxid']+1; */
    $uqry = "INSERT INTO department(departmentName, departmentDescription, postingDate) VALUES ('$departmentName', '$departmentDescription', NOW())";
...
<div class="container"> <!-- open container -->
            ...
            <form action="" method="post" id="survey-form"> <!-- open form -->
                ...
                <div class="row form-group">
                   <div class="col-sm-3">
                    <label id="name-label" class="control-label" for="name">*Department Name:</label>
                   </div>
                  
                   <div class="input-group col-sm-9">
                     <div class="input-group-prepend">
                     </div>                   
                     <input id="name" type="text" class="form-control" placeholder="" name="departmentName" required>
                ...
                <div class="form-group row">
                   <div class="col-sm-3">
                     <label id="email-label" class="control-label" for="email">*Department Description:</label>
                   </div>
                 
                   <div class="input-group col-sm-9">
                     <div class="input-group-prepend">
                     </div>
                     <input type="text" class="form-control" id="email" placeholder="" name="departmentDescription" required>
  ...
  $i=0;
			$qs=mysqli_query($connect,"select * from department");
            ...
            <tr>
                ...
                <td><?php echo $rs['departmentDescription']; ?></td>
				<td><?php echo $rs['postingDate']; ?></td>
