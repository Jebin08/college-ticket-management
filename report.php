...
<div class="link-container">
        <span><a href="datewise-report.php">Datewise</a></span> | 
        <span><a href="department-report.php">Department</a></span>
    </div>
                ...
                <div class="col-xs-1 col-lg-12">
                    <table class="table table-stripped" align="center">
                        <tr>
                            ...
                            <th scope="col-xs-1">Complaint Category</th>
                            <th scope="col-xs-1">Complaint</th>
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="javascript:void(0);" onClick="popUpWindow('complaint-view.php?cid=<?php echo htmlentities($r['complaintNumber']);?>');" title="View Complaint">View Complaint</a>
