...
if(isset($btn))
{
		$uqry="INSERT into block values(NULL, '$block_name', NOW(), NOW())";
...
<div class="container"> <!-- open container -->
            ...
            <form action="" method="post" id="survey-form"> <!-- open form -->
                ...
                <div class="row form-group">
                   <div class="col-sm-3">
                    <label id="name-label" class="control-label" for="name">*Block Name:</label>
                   </div>
                  
                   <div class="input-group col-sm-9">
                     <div class="input-group-prepend">
                     </div>                   
                     <input id="name" type="text" class="form-control" placeholder="" name="block_name" required>
  ...
  $i=0;
			$qs=mysqli_query($connect,"select * from block");
